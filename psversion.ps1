...
if ($psver -lt 5 ) {
    ...
    Write-Host ""
    if ($arch -eq 'x64') {
        Write-Host 'if you have Windows 7, download - Win7AndW2K8R2-KB3134760-x64.msu'
        Write-Host ''
        Write-Host 'if you have Windows 8/8.1, download - Win8.1AndW2K12R2-KB3134758-x64.msu'        
    }
    if ($arch -eq 'x86') {
        Write-Host 'if you have Windows 7, download - Win7-KB3134760-x86.msu'
        Write-Host ''
        Write-Host 'if you have Windows 8/8.1, download - Win8.1-KB3134758-x86.msu'
    }
    Write-Host ''
    Write-Host "press enter and I will bring you to the download page"
    Write-Host ''
    Write-Host ''
    pause
